        ...
        <div class="flex flex-col items-center space-y-4">
          ...
          <div class="text-center">
            <a href="mailto:Stratoneaconsult@gmail.com" class="hover:underline">
              <span> We’d love to hear from you — email us at  stratoneaconsult@gmail.com </span>
            </a>
          </div>
          <!-- Support Us -->
          <div>
           <span class="text-sm" >Help Keep This Free - Momo Us: </span> 
        <button 
          @click="copyToClipboard('0244314463')"
          class="text-white text-sm hover:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 rounded px-2 py-1"
        >
